...
export default function MainContent({ children }: MainContentProps) {
    ...
    return (
        ...
        >
            <HeroSection />
            <ul
                className="flex w-full flex-row items-center justify-start gap-6 pt-12 text-4xl
            ...
            <div
                className="flex w-full flex-row items-center justify-start gap-4 pt-12 text-3xl
                font-medium sm:gap-6 md:text-4xl lg:hidden"
            >
                <NavigationHamburger />
